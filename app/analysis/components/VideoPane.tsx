...
function EnergyGauge({
  ...
  const scoreColor =
    energy > 70 ? "#16a34a" : energy > 40 ? "var(--primary)" : "#dc2626";
  const scoreLabel =
    energy > 70 ? "HIGH ENERGY" : energy > 40 ? "MODERATE" : "LOW ENERGY";
  ...
  return (
    <div
      className="border-2 border-foreground bg-card shadow-md flex flex-col overflow-hidden"
        ...
        <div className="space-y-2">
          {bars.map((bar) => (
            <div
              ...
              style={{ gridTemplateColumns: "6.5rem 1fr 2.5rem" }}
            >
    ...
    <div className="p-6 space-y-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
        <KpiCard
          label="Eye Contact"
          value={videoKpis.eye}
          sub={videoKpis.eyeSub}
          colorClass={videoKpis.eyeColor}
        />
        <KpiCard
          label="Head Stability"
          value={videoKpis.stab}
          sub={videoKpis.stabSub}
          colorClass={videoKpis.stabColor}
        />
        <KpiCard
          label="Expressiveness"
          value={videoKpis.expr}
          sub={videoKpis.exprSub}
          colorClass="text-chart-3"
        />
        <KpiCard
          label="Yawn Alert"
          value={videoKpis.yawn}
          sub={videoKpis.yawnSub}
          colorClass={videoKpis.yawnColor}
        />
        <KpiCard
          label="Energy Score"
          value={videoKpis.energy}
          sub={videoKpis.energySub}
          colorClass={videoKpis.energyColor}
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div
          ref={vidWrapRef}
          className="relative border-2 border-foreground bg-foreground overflow-hidden aspect-video shadow-md"
        >
          <video
            ref={vidRef}
            autoPlay
          ...
          <span
            ref={fpsBadgeRef}
            className="absolute top-2 right-2 z-10 bg-foreground text-background text-[10px] font-mono font-bold px-2 py-1 tracking-widest"
          >
            &mdash; FPS
          </span>
          {gazePos && (
            <div
              ...
              style={{
                left: clamp(gazePos.x, 0, 100) + "%",
                top: clamp(gazePos.y, 0, 100) + "%",
      ...
      <div
        ref={vLogRef}
        className="border-2 border-foreground bg-card p-4 max-h-[280px] overflow-y-auto shadow-md"
      >
        <h3 className="text-[9px] font-mono uppercase tracking-[0.2em] text-muted-foreground mb-2">
