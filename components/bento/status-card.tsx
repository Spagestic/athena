    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col p-4">
        ...
        <p className="text-[10px] font-mono text-muted-foreground mb-4 leading-relaxed">
          Choose from Claude, DeepSeek, ChatGPT, Gemini, or Athena-1. Get
          answers with citations to exact pages or timestamps, grounded in your
          uploaded sources.
        </p>
        ...
        <div className="border border-border divide-y divide-border mb-3">
          {MODELS.map((m) => (
            <div
              key={m.name}
              className="flex items-center justify-between px-3 py-1.5 text-[11px] font-mono hover:bg-muted/30 transition-colors"
            >
        ...
        <div className="mt-auto relative">
          <div className="border border-border flex items-center gap-2 px-3 py-2">
            <span className="text-[9px] font-mono text-muted-foreground border border-border px-1.5 py-0.5 whitespace-nowrap">
              Plan, Build
            </span>
            ...
            <div className="absolute bottom-full left-0 right-0 border border-border bg-background divide-y divide-border z-10 mb-1">
              {[
                ...
                >
                  <span
                    className={
                      m === selectedModel ? "text-[#ea580c]" : "text-foreground"
                    }
                  >
                    {m}
                  </span>
